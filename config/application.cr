...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Scholar Amber web application."
  #
  #
  ...
  #
  # settings.secret_key_base= _WH4uNqf3brTCvGYg7tm6u_8czjI5gJuVWuyNxkhVyk
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("scholar-amber.log", "w"))
  #
  #
end
